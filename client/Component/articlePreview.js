                ...
                <div className="col-12 col-lg-10 isotope-grid">
                    <div className="card card-blog card-horizontal card-md isotope-item" data-filters="lifestyle">
                        ...
                        <div className="card-body">
                            <Link to="/single" className="card-title h5">{article.title}</Link>
                            <div className="card-date">{new Date(article.createdAt).toDateString()}</div>
                            <p className="card-text">{article.description}</p>
                            <Link to="/single" className="btn btn-clean">read more<svg className='icon-arrow icon-arrow-right' width='25' height='10' viewBox='0 0 25 10' fill='none' xmlns='http://www.w3.org/2000/svg'>
