                ...
                <div className="container pt-4">
                    <ul className="nav align-items-center flex-column text-white mb-100">
                        <li className="nav-item">
                            <Link to="" href="mailto:hello@themebau.com?subject=Test%20Address%20Email" className="nav-link h2 mb-8 mb-md-30 d-none d-md-flex">ife.jibola@gmail.com</Link>
                            <Link to="" href="mailto:hello@themebau.com?subject=Test%20Address%20Email" className="nav-link h4 mb-8 mb-md-30 d-md-none">ife.jibola@gmail.com</Link>
                        </li>
                        <li className="nav-item">
                            <Link to="" href="callto:+1202-358-0309" className="nav-link h4 mt-8 mt-md-0">+1 647-447-6545</Link>
                        </li>
                    </ul>
                    ...
                    <div className="footer-copyright mb-5">© 2021 - by Ife Ajibola.</div>
                </div>
            </footer>
