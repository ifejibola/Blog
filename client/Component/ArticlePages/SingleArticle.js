...
import { single, fetch_Articles_List } from '../../actions/articleActions'

function Single(props) {
    // function Single({match}) { // match is an attribute of props(props.match.params). This removes the need to specify props first. useful when the only prop you need is match
    ...
    async function filterArticle(data) {

        let filteredObj = data.find(val => val.post_uuid === props.match.params.id);
    ...
    // console.log('[0]', props.singlepost[0])
    console.log('propssingle post: ', props.singlepost)

    useEffect(() => {
        props.single(props.match.params.id)
                        ...
                        <div key={i}>
                            <div className="row justify-content-center text-center pt-60 pb-130 mt-30">
                                ...
                                <div className="col-12 col-lg-8">
                                    ...
                                    {/* <h1 className="h2 mb-n10 show-on-scroll" data-show-duration="500" data-show-distance="10">{props.singlepost.post_uuid}</h1> */}
                                    <h1 className="h2 mb-n10 show-on-scroll" data-show-duration="500" data-show-distance="10">{data.title}</h1>
                                ...
                                <div className="container">
                                    ...
                                    <div style={{ alignItems: 'center', justifyContent: 'center' }}>
                                        <div className="container">
                                            ...
                                            <img className="w-100 mb-100 show-on-scroll" src={data.default_image} alt="" data-show-duration="800" />
                                            {/* <img className="w-100 mb-100 show-on-scroll" src="public/Uploads/photo-1632324743869-956543350.jpg" alt="" data-show-duration="800" /> */}
                                            ...
                                            <div className="row justify-content-center gh-1 mb-100">
                                                <div className="col-lg-8 post-content">
                                                    <p className="lead font-weight-medium">{data.content}</p>
                                                    <p>{data.content}</p>
...
function loadData(store) {
    console.log('single loadData:', store)
    return store.dispatch(single())
};

function mapStateToProps(state) {
    return {
        // articles: state.articlesReducer.articles,
        singlepost: state.articlesReducer.singlePost
    };
}

export default {
    // loadData,
    component: connect(mapStateToProps, { single })(Single)
